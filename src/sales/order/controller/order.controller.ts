...
import {OrderService} from '@/src/sales/order/services/order.service'
...
export class OrderController {
  ...
  @Post()
  async createOrder(@Body(new ValidationPipe()) order: CreateOrderDto) {
  ...
  async updateOrder(
    ...
    @Body(new ValidationPipe()) order: UpdateOrderDto
  ) {
